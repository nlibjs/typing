...
export * from "./splitString.ts";
export * from "./testValue.ts";
export * from "./is/AlphaNumericString.ts";
export * from "./is/Array.ts";
export * from "./is/Base64String.ts";
export * from "./is/Base64UrlString.ts";
export * from "./is/Boolean.ts";
export * from "./is/CapitalHexString.ts";
export * from "./is/CapitalLatinString.ts";
...
export * from "./is/NumberString.ts";
...
export * from "./is/SmallHexString.ts";
export * from "./is/SmallLatinString.ts";
