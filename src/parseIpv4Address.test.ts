import type {Ipv4AddressParseResult} from './parseIpv4Address';
import {parseIpv4Address} from './parseIpv4Address';

describe(parseIpv4Address.name, () => {
    const validTests: Array<[Parameters<typeof parseIpv4Address>, Ipv4AddressParseResult]> = [
        [['0.0.0.0'], {octets: [0, 0, 0, 0], start: 0, end: 7}],
        [[' 255.255.255.255 ', 1], {octets: [255, 255, 255, 255], start: 1, end: 16}],
    ];
