...
export const isUint8ClampedArray = createTypeChecker(
    'Uint8ClampedArray',
    (input: unknown): input is Uint8ClampedArray => getType(input) === 'Uint8ClampedArray',
);
...
export const isBigUint64Array = createTypeChecker(
    'BigUint64Array',
    (input: unknown): input is BigUint64Array => getType(input) === 'BigUint64Array',
);

export const isBigInt64Array = createTypeChecker(
    'BigInt64Array',
    (input: unknown): input is BigInt64Array => getType(input) === 'BigInt64Array',
);
